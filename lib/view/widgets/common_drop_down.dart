...
//
//   @override
//   CommonDropdownState<T> createState() => CommonDropdownState<T>();
// }
//
// class CommonDropdownState<T> extends State<CommonDropdown<T?>>
...
//       this.radius});
//
//   CommonDropdownState createState() => CommonDropdownState();
// }
//
...
//         color: widget.bgColor ?? lavenderMist,
//         borderRadius: widget.radius ?? BorderRadius.circular(radius10),
//         boxShadow: [
//           BoxShadow(
//               color: Colors.grey,
//               spreadRadius: 0,
...
//         style: fontMedium.copyWith(color: midnightBlue, fontSize: fontSize14),
