          ...
          child: Container(
            ...
            child: Dialog(
              child: SelectionDialog(
                ...
                favoriteElements!,
                hideHeaderText: true,
                headerAlignment: MainAxisAlignment.center, // ✅ Correct type (MainAxisAlignment)
                headerTextStyle: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold), // Required parameter
                topBarPadding: const EdgeInsets.all(8.0), // Required parameter
