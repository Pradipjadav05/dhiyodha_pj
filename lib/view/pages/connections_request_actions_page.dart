...
class ConnectionRequestActionsPage extends StatefulWidget {
  ConnectionRequestActionsPageState createState() =>
      ConnectionRequestActionsPageState();
}

class ConnectionRequestActionsPageState
    extends State<ConnectionRequestActionsPage> {
  @override
  void initState() {
    super.initState();
  }
