...
class SentRequestPage extends StatefulWidget {
  SentRequestPageState createState() => SentRequestPageState();
}

class SentRequestPageState extends State<SentRequestPage> {
  @override
  void initState() {
    super.initState();
  }
        ...
        return Scaffold(
          ...
          body: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return _sentRequestsListItems(index, membersVM);
            },
            itemCount: 30,
          ),
        );
  ...
  _sentRequestsListItems(int index, MembersViewmodel membersVM) {
    return Padding(
