...
//       String? soundData = message.notification?.android?.sound;
//       debugPrint('A bg message : ${message.notification?.android}');
//       debugPrint('sound  :: $soundData');
...
//           sound:
//               RawResourceAndroidNotificationSound(soundData ?? "notification"),
//           priority: Priority.high // Use the custom sound
//           );
//       // var androidPlatformChannelSpecifics = const AndroidNotificationDetails(
//       //     "6ammart", '6ammart', // Change this to your channel name
//       //     channelDescription: "notification description",
//       //     importance: Importance.max,
//       //     playSound: false,
//       //     sound: null,
//       //     icon: "@drawable/notification_icon",
//       //     priority: Priority.max // Use the custom sound
//       //     );
//       var platformChannelSpecifics =
//           NotificationDetails(android: androidPlatformChannelSpecifics);
//       var notificationTitle = title ?? 'Default Title';
//       var notificationBody = body ?? 'Default Body';
//       // VolumeController().maxVolume(showSystemUI: false);
//       // AudioPlayer player = AudioPlayer(playerId: "customNotificationPlayer");
//       // await player.setVolume(1.0);
//       // player.play("assets/notification.wav", isLocal: true);
...
//         notificationTitle,
//         notificationBody,
//         platformChannelSpecifics, // Add any additional payload if needed
//       );
//       NotificationBody notificationBodyData =
//           NotificationHelper.convertNotification(message.data);
//
//       if (notificationBodyData.notificationType == NotificationType.order) {
//         Get.offAllNamed(RouteHelper.getOrderDetailsRoute(
//             int.parse(message.data['order_id']),
//             fromNotification: true));
//       } else if (notificationBodyData.notificationType ==
//           NotificationType.general) {
//         Get.offAllNamed(
//             RouteHelper.getNotificationRoute(fromNotification: true));
//       } else {
//         Get.offAllNamed(RouteHelper.getChatRoute(
//             notificationBody: notificationBodyData,
//             conversationId: notificationBodyData.conversationId,
//             fromNotification: true));
//       }
//     } catch (e, stackTrace) {
