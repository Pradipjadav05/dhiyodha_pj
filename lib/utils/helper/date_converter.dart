...
class DateConverter {
  ...
  static String convertDateToNumMonth(DateTime dateTime) {
  ...
  static bool isAvailable(String? start, String? end,
    ...
    if (time != null) {
      ...
      currentTime = Get.find<SplashViewModel>().currentTime;
    }
  ...
  static String _timeFormatter() {
    return 'HH:mm';
    // return Get.find<SplashViewModel>().configModel!.timeformat == '24'
    //     ? 'HH:mm'
    //     : 'hh:mm a';
  }
